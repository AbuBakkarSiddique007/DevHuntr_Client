    ...
    <header className="sticky top-0 z-50 w-full border-b border-white/10 bg-background/70 backdrop-blur-xl supports-[backdrop-filter]:bg-background/40 transition-all duration-300">
      <div className="container mx-auto px-4 h-16 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2 group">
          <div className="relative flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 text-white shadow-lg shadow-purple-500/30 group-hover:scale-105 transition-transform duration-300">
        ...
        <div className="hidden md:flex items-center gap-4">
          {user ? (
            ...
            <>
              ...
              <Link href="/register">
                <Button className="rounded-full bg-gradient-to-r from-indigo-500 to-purple-600 hover:opacity-90 shadow-lg shadow-indigo-500/25 transition-all hover:-translate-y-0.5">
                  Get Started
                </Button>
              </Link>
            </>
        ...
        <div className="md:hidden absolute top-16 left-0 w-full bg-background/95 backdrop-blur-3xl border-b border-border p-4 flex flex-col gap-4 animate-in slide-in-from-top-4 fade-in-90">
          ...
          {user ? (
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link href="/register"><Button className="w-full bg-gradient-to-r from-indigo-500 to-purple-600">Get Started</Button></Link>
            </div>
          )}
        </div>
      )}
