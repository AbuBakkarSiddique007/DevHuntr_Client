    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative overflow-hidden pt-24 pb-32 lg:pt-36 lg:pb-40">
        ...
        <div className="container px-4 mx-auto flex flex-col items-center text-center relative z-10">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight max-w-4xl text-transparent bg-clip-text bg-gradient-to-br from-white via-white/90 to-white/40 mb-6 animate-in slide-in-from-bottom-6 duration-700">
      ...
      <section className="py-20 bg-black/50 border-y border-border/30 relative z-10">
        <div className="container mx-auto px-4">
          <div className="flex items-center justify-between mb-12">
            <div>
              <h2 className="text-3xl font-bold tracking-tight mb-2">Trending Right Now</h2>
              <p className="text-muted-foreground">The most upvoted products today.</p>
            </div>
            <Link href="/products">
